...
# Original script: Copyright (C) 2018 Jasper Boom

# Edited July 2020 by Heleen Bouwer
...
# =======================
# As of July 2020: takes species as third column and otuname as first column, currently no Format options
